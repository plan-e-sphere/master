<h1>Conditions générales d'utilisation de Plan-E-Sphere</h1>
<br/>
<h3>ARTICLE 1 : Objet</h3>
<br/>
<p>Les présentes « conditions générales d'utilisation » ont pour objet l'encadrement juridique des modalités de mise à disposition des services du site www.plan-e-sphere.fr et leur utilisation par « l'Utilisateur ».
...
PLAN-E-SPHERE se réserve le droit de modifier unilatéralement et à tout moment le contenu des présentes conditions générales d'utilisation.</p>
<br/>
<h3>ARTICLE 2 : Mentions légales</h3>
<br/>
<p>L'édition et l'hébergement du site www.plan-e-sphere.fr est assurée par la Société PLAN-E-SPHERE [SAS / SA / SARL, etc.] au capital de [montant en euros] € dont le siège social est situé au [adresse du siège social].
...
Tout événement dû à un cas de force majeure ayant pour conséquence un dysfonctionnement du réseau ou du serveur n'engage pas la responsabilité de PLANESPHERE.<br/>
...
L'Utilisateur a la possibilité de contacter le site par messagerie électronique à l’adresse contact@plan-e-sphere.fr.</p>
<br/>
...
un formulaire de <a href="http://plan-e-sphere.fr/contact">Contact</a>;<br/>
par mail à contact@plan-e-sphere.fr ;<br/>
...
<br/>
<p>De nombreux liens hypertextes sortants sont présents sur le site, cependant les pages web où mènent ces liens n'engagent en rien la responsabilité de PLAN-E-SPHERE qui n'a pas le contrôle de ces liens.
...
<br/>
<p>Le site permet aux membres de publier des œuvres personnelles( photographies, vidéos etc.) et des commentaires.<br/>
